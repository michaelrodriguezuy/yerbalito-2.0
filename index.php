...
$query = "SELECT * FROM jugador WHERE idcategoria<>10 AND idcategoria<>9 ";
        ...
        <!- ----------------------------- JS ----------------------------- ->
            ...
            <!- ----------------------------- FONT AWESOME ----------------------------- ->
                ...
                <!- ----------------------------- GOOGLE FONTS ----------------------------- ->
                    ...
                    <link href="https://fonts.googleapis.com/css2?family=Signika+Negative:wght@400;700&display=swap"
                        rel="stylesheet">
                    <link
                        href="https://fonts.googleapis.com/css2?family=PT+Sans+Narrow&family=Signika+Negative:wght@400;700&display=swap"
                        rel="stylesheet">
...
-->
        <p class="p">
            El Club Yerbalito de Baby Fútbol es una Institución que cuenta con más de 45 años de existencia situada en
            la
            ciudad de Treinta y Tres y que hace ocho años logró tramitar y obtener la personería jurídica; se dedica a
            la
            práctica de fútbol infantil, donde recibe semanalmente a más de 150 niños y niñas, pero hace un par de años
            viene
            desarrollando otras actividades conexas en beneficio del crecimiento físico y mental de los niños que en
            ésta
            participan, lo cual le permite realizar una tarea social considerada muy importante para la sociedad.
        </p>
