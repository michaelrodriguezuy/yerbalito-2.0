	...
	for (var x=0; x < checkboxes.length; x++) {
	 if (checkboxes[x].checked) {
	  cont = cont + 1;
		...
		document.getElementById("monto").value = 350 * cont;			
...
{	
	 ...
	 window.location.href=window.location.href + "&monto=" + monto_js + "&precio_confirmado=1" + "&anio2=2022" + "&cuota_1=" + cuota_1 + "&cuota_2=" + cuota_2; 	 	 
}
...
<div id="wrapper">
  ...
  <div id="header">
    <!-- Social -->
    <div align="center"> <img src="images/logo3.png" alt="yerbalito" class="header" longdesc="images/logo3.png" hspace="0" vspace="0" border="0" > </div>
    <!-- ENDS Social -->
    <!-- Navigation -->
    <!-- Navigation -->
    <!-- search -->
		...
		if ($row_cnt8==0){ //LO USO CUANDO MUESTRO POR PRIMERA VES, NO HE SELECCIONADO UN JUGADOR 
               ...
               <tr>
         			   <td><label>
          			    ...
          			    Cuota 1 (Campeonato Apertura) </label></td>
        		   </tr>
                <?php } else {
					?>
                    <tr>
               ...
               <tr>
        	    ...
        	    <td><label style=" font-weight:bold">
      	        ...
      	        Cuota 2 (Campeonato Clausura) </label></td>
      	  	 	</tr>
                    <?php 
					} ?>
