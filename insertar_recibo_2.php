...
elseif ($row_cnt+1==date("n")) //si es = a 1 mes anterior y no ha llegado al dia 10, esta al dia
{
	$mysqli->query("Update jugador Set idestado=2 Where jugador.idjugador ='".$jugadorQuePago."'");		
...
?> 
            ...
            <tr valign="baseline">
              ...
              <td>
              <input type="text" name="monto" id="monto" value="" size="32"> (Si es un jugador sin fichar el importe es $150)       
