(function($) {
  ...
  $.fn.tweet = function(o){
    var s = $.extend({
      username: ["Micha_33"],                // [string]   required, unless you want to display our tweets. :) it can be an array, just do ["username1","username2","etc"]
      ...
      auto_join_text_default: "Yo puse,",        // [string]   auto text for non verb: "i said" bullocks
      auto_join_text_ed: "yo",                   // [string]   auto text for past tense: "i" surfed
      auto_join_text_ing: "yo estaba",               // [string]   auto tense for present tense: "i was" surfing
      auto_join_text_reply: "yo respondi",     // [string]   auto tense for replies: "i replied to" @someone "with"
      auto_join_text_url: "yo estuve mirando",   // [string]   auto tense for urls: "i was looking at" http:...
