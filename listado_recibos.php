...
$query_DatosRecibo = "SELECT *, jugador.idjugador, jugador.nombre FROM recibo, jugador WHERE recibo.idjugador = jugador.idjugador AND recibo.visible = 1 ORDER BY recibo.idrecibo DESC";
	...
	<div id="wrapper">
	  ...
	  <div id="main">   
		...
		?>
          ...
          <a href="insertar_recibo.php"><img src="img/knobs-icons/Knob Add.png" width="32" height="32" longdesc="img/knobs-icons/Knob Add.png" title="Insertar recibo"></a>

          <? ;} ?>

          		            	

            <input name="reciboDEjugador" type="text" title="Nombre del jugador">
...
if($_POST['reciboDEjugador'])

{

	$variable = $_POST['reciboDEjugador'];
	...
	{		
...

		{
			...
			$sql="select * from recibo WHERE visible = 1 AND idjugador=".$row2['idjugador']." ORDER BY idrecibo DESC"; 
				...
				{ 	
					...
					while($row3=mysql_fetch_array($result3))
				    	...
				    	<tr>      
						    ...
						    <td><?php echo $row['fecha_recibo']; ?></td>    
		...
		?>
                            ...
                            <a href="modificar_recibo.php?recordID=<?php echo $row['numero']; ?>"><img src="img/knobs-icons/Knob Smart.png" width="32" height="32" border="0" title=	"Modificar recibo"></a>     
...
$sql_code = "select * from recibo WHERE visible = 1 ORDER BY idrecibo DESC LIMIT $desde,$cantidad_x_pagina";
...
$sql_code2 = "select * from recibo WHERE visible = 1";
		  ...
		  ?>
				  ...
				  <ul class="pagination">
                    ...
                    <li>
				      ...
				      <a href='<?php echo "listado_recibos.php?pagina=$anterior"?>' aria-label="Anterior">
					...
					<?php if($pagina_actual>=1) {
					    ...
					    for($i=1;$i<=$num_paginas_total;$i++){
							...
							echo ($i==$pagina_actual) ? "<li class='active'><a href='listado_recibos.php?pagina=$i'>$i</a></li>":

							"<li> <a href='listado_recibos.php?pagina=$i'>$i</a></li>";
                    ...
                    <li>
                    	...
                    	<a href=' <?php echo "listado_recibos.php?pagina=$siguiente"?>' aria-label="Siguiente">
