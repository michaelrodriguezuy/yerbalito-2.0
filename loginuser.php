...
$query_Recordset1 = sprintf("SELECT * FROM usuario WHERE usuario = %s", GetSQLValueString($varDato_Recordset1, "text"));
$Recordset1 = mysql_query($query_Recordset1, $qrmascotas) or die(mysql_error());
...
if (isset($_POST['usuario'])) {
  ...
  $MM_redirectLoginSuccess = "mi_mascota.php?recordID=".$loginUsername;
  ...
  $LoginRS = mysql_query($LoginRS__query, $qrmascotas) or die(mysql_error());
 ...
 <!-- favicon-->
	...
	<div id="wrapper">
		...
		<!-- ENDS HEADER -->
    		...
    		<!-- MAIN -->
	  <div id="main" align="center"> Ingresar al sitio:
	...
	<div id="footer">				
				...
				<!-- Bottom -->
				<div id="bottom">
				<a href="http://yerbalito.olimarteam.com/qrmascotas.com" >Mascotas QR</a> es una plantilla de <a href="http://olimarteam.com"> Olimarteam</a></div>
				<!-- ENDS Bottom -->
	  </div>
		<!-- ENDS FOOTER -->
