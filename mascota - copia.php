...
$query_DatosMascotas = sprintf("SELECT mascota.id_mascota, mascota.tipo, mascota.apodo, mascota.foto, mascota.raza, mascota.color, mascota.fecha_nacimiento, mascota.fecha_ingreso, mascota.observacion, usuario.nombre, mascota.identificacion FROM mascota, usuario WHERE mascota.id_usuario = usuario.id_usuario AND mascota.identificacion = %s", GetSQLValueString($varDato_DatosMascotas, "text"));
...
mysql_select_db($database_qrmascotas, $qrmascotas);
$query_Datosmascotas = sprintf("SELECT * FROM mascota, usuario WHERE mascota.id_usuario = usuario.id_usuario AND mascota.identificacion = %s", GetSQLValueString($varDato_Datosmascotas, "text"));
$Datosmascotas = mysql_query($query_Datosmascotas, $qrmascotas) or die(mysql_error());
$row_Datosmascotas = mysql_fetch_assoc($Datosmascotas);
...
mysql_select_db($database_qrmascotas, $qrmascotas);
$query_DatosMascotas = sprintf("SELECT mascota.id_mascota, mascota.tipo, mascota.apodo, mascota.foto, mascota.raza, mascota.color, mascota.fecha_nacimiento, mascota.fecha_ingreso, mascota.observacion, usuario.nombre, mascota.identificacion FROM mascota, usuario WHERE mascota.identificacion = %s", GetSQLValueString($varDato_DatosMascotas, "text"));
$DatosMascotas = mysql_query($query_DatosMascotas, $qrmascotas) or die(mysql_error());
$row_DatosMascotas = mysql_fetch_assoc($DatosMascotas);
$totalRows_DatosMascotas = mysql_num_rows($DatosMascotas);
*/
...
<h1> Datos del dueño: </h1>
	...
	<div id="footer">				
				...
				<!-- Bottom -->
				<div id="bottom">
				<a href="#" >Mascotas QR</a> es una plantilla de <a href="http://olimarteam.com"> Olimarteam</a></div>
				<!-- ENDS Bottom -->
	  </div>
		<!-- ENDS FOOTER -->
