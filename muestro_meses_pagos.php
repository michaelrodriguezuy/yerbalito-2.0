	  ...
	  <div id="main"> Insertar recibo:
        <form method="post" name="form1" action="<?php echo $editFormAction; ?>"> 
          ...
          <table align="center">
            ...
            <tr valign="baseline">
              <td nowrap align="right">Numero de recibo:</td> <!-- tomo el valor "numero_recibo" del ultimo recibo ingresado, le sumo 1 y lo muestro-->
              <td><input type="text" name="numero" value="" readonly size="32">  </td>
            </tr>
...
do {  
?>
                <option value="<?php echo $row_DatosJugador['idjugador']?>" <?php if (!(strcmp($row_DatosJugador['idjugador'], $row_DatosJugador['nombre']))) {echo "selected=\"selected\"";} ?> > <?php echo $row_DatosJugador['apellido']?>, <?php echo $row_DatosJugador['nombre'] ?> </option>
                <?php 						
				}  									
...
?>
         ...
         <input name="boton" id="boton" type="submit" value="Consultar pagos del jugador">
          </td>
          
            </tr>
                                              
            
            <?php $param= $_GET['idjugador'];?>
            
            <tr valign="baseline">
              <td nowrap align="right">Mes a pagar: <?php echo $param  ?> </td>
              <td align="left">     
...
while ($fila = mysqli_fetch_row($result8)) {
?>            
                                    
                <tr>         
               
                 <td><label>
                 <!-- veo si tiene este mes pago, si esta pago lo desabilito-->
                 
                    <input  type="checkbox" name="mes_pago[]" value="1" id="mes_pago_0" <?php  		
 			   ...
 			   ?> 
                        onClick="javascript:contar();"> Enero <?php printf ("%s\n", $fila[2]); ?></label></td>
                </tr>
                ...
                <tr>
                  <td><label>
                    <input  type="checkbox" name="mes_pago[]" value="2" id="mes_pago_1" <?php
 ...
 ?> onClick="javascript:contar();">
                    Febrero <?php echo $row_cnt?></label></td>
                </tr>
 ...
 ?> onClick="javascript:contar();">
            ...
            <tr valign="baseline">
              ...
              <td><input type="text" name="anio" value="2019" size="32"></td>
            </tr>
            <tr valign="baseline">
              <td nowrap align="right">Monto:</td>
              <!-- calculo la cantidad de meses marcados *250 y lo pongo en value-->
              <td>
              <input type="text" name="monto" id="monto" value="" size="32"> (Si es un jugador sin fichar el importe es $200)       
